...
void PngBufferReader::setRgbToGray() { png_set_rgb_to_gray(pngPtr_, 1, 0.2126, 0.7152); }
void PngBufferReader::setScaleDownTo8() { png_set_scale_16(pngPtr_); }
void PngBufferReader::setExpandTo8() { png_set_expand_gray_1_2_4_to_8(pngPtr_); }
void PngBufferReader::setBgr() { png_set_bgr(pngPtr_); }
void PngBufferReader::setStripAlpha() { png_set_strip_alpha(pngPtr_); }
void PngBufferReader::setAddAlpha(int filler) {
  png_set_add_alpha(pngPtr_, filler, PNG_FILLER_AFTER);
}

void PngBufferReader::setPaletteToRgb() { png_set_palette_to_rgb(pngPtr_); }

void PngBufferReader::setGrayToRgb() { png_set_gray_to_rgb(pngPtr_); }
