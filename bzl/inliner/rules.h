...
#define _C8_BUILD_CREATE_NAME(rule, token) _C8_BUILD_CREATE_NAME_INNER(rule, token)
...
#define _C8_BUILD_CC_LIBRARY                                                     \
  static void _C8_BUILD_CREATE_NAME(cc_library, __LINE__)(                       \
    ...
    std::initializer_list<const char *> compatible_with __attribute__((unused)), \
    ...
    std::initializer_list<const char *> target_compatible_with __attribute__((unused)))
