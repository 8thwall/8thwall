...
import {initDb} from './storage/application-state'
...
import {registerOnOpenUrlHandler} from './native/register-on-open-url-handler'
...
import {registerSecondInstanceHandler} from './native/register-second-instance-handler'
import {registerPermissionHandler} from './native/permissions'
import {navigateToDeepLink} from './native/deep-link'
import {setupMenu} from './native/menu'
